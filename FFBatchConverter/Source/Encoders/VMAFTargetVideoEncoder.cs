...
internal class VMAFTargetVideoEncoder
{
    ...
    internal void Start(string ffmpegArguments, bool h265, double targetVMAF, string outputFilePath)
    {
        ...
        // VideoEncoder is defined in constructor.
        Debug.Assert(VideoEncoder != null, nameof(VideoEncoder) + " != null");
        VideoEncoder.InfoUpdate += OnEncoderInfoUpdate;
    ...
    private void Step2()
    {
        ...
        if (VideoEncoder!.VMAFScore > TargetVMAF) // VideoEncoder is defined in constructor.
        {
